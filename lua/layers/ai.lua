...
Ai.init = function()
	...
	codecompanion.setup({
		allday = { -- CodeCompanion AI
			...
			auto_insert = true, -- Toggle auto insertion of text when there is only one edit
			auto_apply = true,  -- Automatically apply changes without confirmation
			auto_tool_mode = true, -- Allow the AI to automatically use tools
			ui = {
				popup = {
					border = "rounded",
					width = 100,
